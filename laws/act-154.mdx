...
1\. (1) This Act may be called the <sup><a id="fnref-2" href="#fn-2">2</a></sup> [* * *] [State Aid to Industries Act, 1931](/laws/act-154 "Act 154") .
...
(b) one member, being an employee of the <sup><a id="fnref-3" href="#fn-3">3</a></sup> [Bangladesh Bank] to be appointed by Government;

(c) two members to be elected by the <sup><a id="fnref-4" href="#fn-4">4</a></sup> [Parliament] from among the members of <sup><a id="fnref-5" href="#fn-5">5</a></sup> [Parliament];
...
(f) one member to be appointed by the Government from the panel of names submitted (in the prescribed manner) by different registered Chambers of Commerce and Industries in <sup><a id="fnref-6" href="#fn-6">6</a></sup> [Bangladesh] other than those mentioned in clauses (d) and (e);
...
Provided that no State aid shall be given to any joint stock company unless the company is registered in Bangladesh with a <sup><a id="fnref-11" href="#fn-11">11</a></sup> [Taka] capital, and the Government approves the composition of the Board of Directors of the company:
