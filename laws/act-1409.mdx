...
(2)        In case of registration or fitness renewal of a vehicle for more than one year, advance tax under sub-section (1) shall be collected on or before 30 <sup><a id="fnref-th" href="#fn-th">th</a></sup> June in every subsequent year or years following the year in which registration or fitness renewal of the vehicle has been done.
